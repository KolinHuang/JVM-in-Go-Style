...
import (
	...
	"jvmgo/chap06/instructions/comparisons"
	"jvmgo/chap06/instructions/constants"
	"jvmgo/chap06/instructions/control"
	"jvmgo/chap06/instructions/conversions"
	"jvmgo/chap06/instructions/extended"
	"jvmgo/chap06/instructions/loads"
	"jvmgo/chap06/instructions/math"
	"jvmgo/chap06/instructions/references"
	"jvmgo/chap06/instructions/stack"
	"jvmgo/chap06/instructions/stores"
)
